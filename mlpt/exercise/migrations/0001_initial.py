...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='exercise',
            name='equipments',
            field=models.ManyToManyField(through='exercise.ExerciseEquipmentItems', to='exercise.EquipmentItem'),
        ),
        migrations.AddField(
            model_name='exercise',
            name='people_types',
            field=models.ManyToManyField(through='exercise.ExercisePeopleType', to='exercise.PeopleType'),
        ),
        migrations.AddField(
            model_name='exercise',
            name='units',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exercise.equipmentitem')),
            ],
        ),
        migrations.AddField(
            model_name='equipment',
            name='combat_loads',
            field=models.ManyToManyField(help_text='A list of equipment ammo that this equipment contains.', to='exercise.EquipmentCombatLoadItem'),
        ),
